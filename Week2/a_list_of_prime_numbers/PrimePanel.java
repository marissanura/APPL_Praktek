...
public class PrimePanel extends JPanel {
    ...
    public PrimePanel(){
        ...
        primeList = new JScrollPane(textArea);
        primeList.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
    ...
    public class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            try {
                ...
                textArea.setText("Your input isn't integer");
            }
