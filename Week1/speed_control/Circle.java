// **************************************************************** // FILE: Circle.java
//
// Purpose: Define a Circle class with methods to create and draw a circle of random size, color, and location.
// ****************************************************************
...
public class Circle 
{
    ...
    // negative to the left); "down" is the number of pixels // to move vertically (positive is down; negative is up) 
    //--------------------------------------------------------
